...
ace.define(
  "ace/mode/colon_highlight_rules",
  [
    "require",
    "exports",
    "module",
  ...
  function(require, exports, module) {
    ...
    var colonHighlightRules = function() {
      var keywordControls = "break|case|continue|default|do|goto|" + "switch";
      ...
      var colonRegex =
        "(?:\\s*|)(?:(?:v|c|i|e|ei|wl|fl|d|w|f|r|<|=):|(?:i|e|ei|wl|fl|f|=);)";
    ...
    oop.inherits(colonHighlightRules, TextHighlightRules);

    exports.colonHighlightRules = colonHighlightRules;
  }
);
...
ace.define(
  ...
  function(require, exports, module) {
    ...
    var colonHighlightRules = require("./colon_highlight_rules")
      .colonHighlightRules;
    ...
    var Mode = function() {
      this.HighlightRules = colonHighlightRules;
